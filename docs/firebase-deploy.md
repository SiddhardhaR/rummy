...
This repository is configured to deploy the Next.js app to Firebase Hosting when code is pushed to the `main` branch.

Required GitHub repository secrets:

- `FIREBASE_SERVICE_ACCOUNT_RUMMY_91870`: JSON service account key for the Firebase project `rummy-91870`.
...
The frontend is deployed by `.github/workflows/firebase-hosting-main.yml`.
